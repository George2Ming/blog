...
class ArticleModel extends Model {
	...
	public function insertArt($art) {
		...
		$addtime = time();
		// 入库
		$sql = "insert into bg_article values (null, $cate_id, '$title', '$thumb', '$art_desc', '$content', '$author', default, $addtime,default,default,default)";
	...
	*彻底删除文章
	 */
	public function realdel($art_id){
	...
	*批量彻底删除文章
	 */
	public function realdelAll($art_ids){
